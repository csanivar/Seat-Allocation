...
public class GaleShapleyAdmission {
			...
			for(int k=0;k<K;k++){
				...
				for(int p=0;p<P;p++){
					if(applied_candidates.size()<virtualProgramme.quota){
						...
						ArrayList<Candidate> top_q_candidates = getTopQCandidates(applied_candidates,virtualProgramme.getCategory());
	...
	public static ArrayList<Candidate> getTopQCandidates(ArrayList<Candidate> applied_candidates,String merit_list_name){
